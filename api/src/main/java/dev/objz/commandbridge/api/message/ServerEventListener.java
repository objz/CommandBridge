 ...
 *
 * <p>This is a {@code @FunctionalInterface} and may be used as a lambda expression. Register
 * listeners via {@link dev.objz.commandbridge.api.CommandBridgeAPI#onServerConnected(ServerEventListener)}
 * and {@link dev.objz.commandbridge.api.CommandBridgeAPI#onServerDisconnected(ServerEventListener)}.
 * Both methods return an {@link java.util.Optional} wrapping a {@link dev.objz.commandbridge.api.message.Subscription}
...
public interface ServerEventListener {
     ...
     *
     * @param server the server involved in the event, providing its unique identifier via
     *               {@link dev.objz.commandbridge.api.platform.Platform.ServerTarget#id()} and its
     *               platform type via {@link dev.objz.commandbridge.api.platform.Platform.ServerTarget#type()}
     */
