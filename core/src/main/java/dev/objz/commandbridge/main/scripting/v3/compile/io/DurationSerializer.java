package dev.objz.commandbridge.main.scripting.v3.serialize;
...
/**
 * Accepts: 150ms, 2s, 3m, 1h, 1d, or ISO-8601 (e.g. PT2S).
 * Numbers w/o unit are treated as milliseconds.
 */
public final class DurationSerializer implements TypeSerializer<Duration> {
	...
	public void serialize(Type type, Duration obj, ConfigurationNode node) throws SerializationException {
		node.set(obj == null ? null : obj.toString()); // write ISO-8601
	}
}
